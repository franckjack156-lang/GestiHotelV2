...
// TODO: AllowedColor imported but unused
...
const getColorClasses = (color?: string): string => {
  ...
  const colorMap: Record<string, string> = {
    ...
    violet:
      'bg-violet-100 text-violet-800 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400',
    purple:
      'bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/20 dark:text-purple-400',
    fuchsia:
      'bg-fuchsia-100 text-fuchsia-800 border-fuchsia-200 dark:bg-fuchsia-900/20 dark:text-fuchsia-400',
